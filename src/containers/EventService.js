...
/**
 * Display EventService page
 *
 * @visibleName EventService
 */
                ...
                <div className="cols-4">
                    <div className="panel">
                        ...
                        <div className="padding-top panel-text-small">
                            <IconLabelLink link="/allevents" icon="launch" label="View a list of all events in the 2020 series." color="blue" />
                        </div>
                        <div className="padding-top panel-text-small">
                            <IconLabelLink link="/allevents2019" icon="launch" label="View a list of all events in the 2019 series." color="blue" />
                        </div>
                        <Separator />
                        <div className="padding-top panel-text-small">
